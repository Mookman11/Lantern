...
| Legacy public mirror route | retired hosted mirror files | Local npm runtime plus verified static mirrors |
| HFF Render mirror as Lantern status source | `human-flourishing-frameworks.onrender.com` | Local-held HFF status until a verified public endpoint exists |
...
| Local-held HFF status | Requires fresh local or verified endpoint evidence before public claims |
